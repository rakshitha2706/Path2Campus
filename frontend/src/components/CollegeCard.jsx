...
export default function CollegeCard({
  college, exam, onSave, onCompare, isSaved, isCompared
}) {
    ...
    <div className="card p-5 animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="bg-slate-50 rounded-lg p-3">
          ...
          <div className="font-bold text-slate-800 text-sm">{college.closing_rank?.toLocaleString() ?? '—'}</div>
        </div>
        {exam === 'eapcet' && (
          <div className="bg-slate-50 rounded-lg p-3">
        ...
        {exam === 'josaa' && (
          <div className="bg-slate-50 rounded-lg p-3">
            ...
            <div className="font-bold text-slate-800 text-sm">{college.opening_rank?.toLocaleString() ?? '—'}</div>
          </div>
        )}
      </div>
